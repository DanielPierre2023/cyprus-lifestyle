...
export const QA_DOMAINS: QADomain[] = [
  ...
  },
  {
    ...
    intents: [
      { id: 'emergencies',
        q: 'What are the emergency numbers and where are the hospitals?',
        a: '112 reaches police, ambulance and fire. Every city has an A&E, and pharmacies run a rotating all-night duty roster. Save your nearest hospital and a 24-hour pharmacy before you need them — we list both by town.',
        resources: [{ label: 'Health & medical directory', path: '/directory/g/health', status: 'live' }],
        links: ['english-doctor', 'safe-family'], connect: ['Hospitals', 'Pharmacies'] },
      { id: 'english-doctor',
      ...
      { id: 'pharmacies',
        ...
        resources: [{ label: 'Health & medical directory', path: '/directory/g/health', status: 'live' }],
        links: ['emergencies'], connect: ['Pharmacies'] },
      { id: 'family-beaches',
